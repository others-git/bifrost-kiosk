...
/**
 * Picks a thread count for whisper inference: the number of high-performance
 * cores (so we don't schedule the heavy transcribe onto little cores), at least
 * 2. Vendored from whisper.cpp/examples/whisper.android.
 */
